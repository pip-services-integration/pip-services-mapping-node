# Configuration Guide <br/> Mappings Microservice

Mappings microservice configuration structure follows the 
...
Example:
```yaml
- descriptor: "pip-services-mappings:persistence:memory:default:1.0"
  options:
    max_page_size: 100
```
